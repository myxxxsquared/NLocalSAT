...
void parseParameters(int argc, char *argv[]) {
	...
	static const struct option long_options[] = { { "luby_base", required_argument, 0, 'u' }, { "luby", no_argument, 0, 'l' }, { "timeout", required_argument,
			0, 11 }, { "randomc", required_argument, 0, 'r' }, { "c1", required_argument, 0, 'b' }, { "c2", required_argument, 0, 'e' }, { "c3",
			required_argument, 0, 'd' }, { "sp", required_argument, 0, 'p' }, { "runs", required_argument, 0, 't' }, { "maxflips", required_argument, 0, 'm' },
			{ "printSolution", no_argument, 0, 'a' }, { "help", no_argument, 0, 'h' }, { 0, 0, 0, 0 } };
